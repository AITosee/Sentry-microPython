...
while True:
    ...
    if obj_num:
        ...
        for i in range(1,obj_num+1):
            ...
            w = sentry.GetValue(sentry2_vision_e.kVisionMotionDetect, sentry_obj_info_e.kWidthValue, i)
            h = sentry.GetValue(sentry2_vision_e.kVisionMotionDetect, sentry_obj_info_e.kHeightValue, i)
